...
const getReceipts = async(req, res) => {
    try {
        ...
        // Parse items JSON for each receipt and handle customer information
        const receiptsWithItems = receipts.map((receipt) => {
            ...
            const customerName =
                receipt.customer_name_from_table || receipt.customer_name;
            const customerEmail =
                receipt.customer_email_from_table || receipt.customer_email;
            ...
            return {
                ...
                customer_name_from_table: undefined,
                customer_email_from_table: undefined,
            };
        });
