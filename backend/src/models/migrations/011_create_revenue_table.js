exports.up = function(knex) {
  return knex.schema.createTable('revenue', function(table) {
    ...
    table.string('source').notNullable(); // sales, services, investments, other
    table.string('payment_method').defaultTo('cash');
    table.string('status').defaultTo('received'); // received, pending, overdue
...
exports.down = function(knex) {
  return knex.schema.dropTable('revenue');
};
